...
export function Hero() {
  ...
  return (
    <section ref={containerRef} className="container mx-auto px-4">
      <div className="min-h-[93vh] flex flex-col justify-center py-24 md:py-32 max-w-4xl">
        ...
        <p className="hero-desc text-base sm:text-xl md:text-2xl text-muted-foreground font-light leading-relaxed max-w-2xl mb-10">
          I build scalable web applications — from API design to pixel-perfect
          UI. NestJS, Next.js, TypeScript.
        </p>
      </div>
    </section>
  );
